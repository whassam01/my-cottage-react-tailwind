...
import { useCreateConsumerAddress, useGetAddresses } from 'store/react-query';
...
const AddressForm = (props) => {
  ...
  return (
    <Modal
      maskClosable={!createConsumerAddress.isLoading && !addressQuery.isLoading}
